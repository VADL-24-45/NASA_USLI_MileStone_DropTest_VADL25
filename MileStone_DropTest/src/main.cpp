...
float landingAccMagThreshold = 15;               // m/s^2
float GroundLevel = 150;                         // CHANGE THIS VALUE TO CALIBRATE IMU
float landingAltitudeThreshold = GroundLevel + 20;
float initialAltitudeThreshold = 10;
...
void logData()
{
    detectLanding(localCopy.localAltitude, localCopy.localAccMag); // Has to be in here
    Serial.print("Time: ");
    ...
    Serial.print(localCopy.localQz); Serial.print(", ");
    Serial.print(initialAltitudeAchieved); Serial.print(", ");
    Serial.println(landedState);
